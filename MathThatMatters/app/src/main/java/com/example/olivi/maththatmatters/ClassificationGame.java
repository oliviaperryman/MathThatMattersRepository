 ...
 */
public class ClassificationGame extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        properShapes = new int[2];
        properShapes[0] = R.drawable.proper_similar_shape_1;
        properShapes[1] = R.drawable.proper_similar_shape_2;


        notShapes = new int[1];
        notShapes[0] = R.drawable.not_similar_shape_3;
    ...
    public void playRound(int n){
        ...
        if (i < 2) {
            ...
            img.setImageResource(notShapes[i - 2]);
            proper = false;
        }
    }
